...
- 🔭 Building **LogPlane** — log observability platform (React + Rust, private repo)
- 🧭 Frontend background in **Vue 3** admin systems; expanding to **React / TypeScript** full-stack
- 💻 Also learning: design patterns, async Rust (Tokio / Axum), Vitest & CI workflows
- ⚡ Interests: open source, reading, running
...
- 🌐
  ...
  ![Tailwind CSS](https://img.shields.io/badge/-Tailwind-333333?style=flat&logo=tailwindcss&logoColor=06B6D4)
